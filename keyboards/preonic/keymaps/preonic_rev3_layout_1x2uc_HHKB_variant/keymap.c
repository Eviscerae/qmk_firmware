 ...
 * |------+------+------+------+------+-------------+------+------+------+------+------|
 * | Caps |Ctrl+A|Ctrl+S|Ctrl+D|Ctrl+F| TRNS | TRNS |   1  |   2  |   3  |   -  |  "   |
 * |------+------+------+------+------+------|------+------+------+------+------+------|
 ...
 */
	[_LOWER] = LAYOUT_preonic_1x2uC(
        KC_GRV,   KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_F5,    KC_F6,    KC_P7,    KC_P8,    KC_P9,    KC_PEQL,  KC_DEL,
        KC_TRNS,  KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_F11,   KC_F12,   KC_P4,    KC_P5,    KC_P6,    KC_PPLS,  KC_PAST,
        KC_CAPS,  CTL_A,    CTL_S,    CTL_D,    CTL_F,    KC_TRNS,  KC_TRNS,  KC_P1,    KC_P2,    KC_P3,    KC_PMNS,  KC_PSLS,
        KC_TRNS,  CTL_Z,    CTL_X,    CTL_C,    CTL_V,    KC_TRNS,  KC_TRNS,  KC_P0,    KC_P0,    KC_PDOT,  SHFT_HME, SHFT_END,
